...
public class HolidayController {
     ...
     * If Database file exist, existing records are read and new holiday object is
     * aopended before saving
     * If Database file does not exist, holiday object will be written to a new file
     * and saved
     * 
    ...
    /**
     * Check if a date is an holiday by checking against every records in the
     * Database file
     * 
